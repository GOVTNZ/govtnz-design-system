...
const FileUploadWithErrorMessage = ({ fileUpload3, fileUpload3Hint, fileUpload3Error, name, disabled, readOnly, autoFocus }) => (React.createElement("div", { className: "g-fileUploadWithErrorMessage-form-group g-fileUploadWithErrorMessage-form-group--error" },
