...
declare const TextareaWithAutocompleteAttribute: {
    ({ textareaWithAutocompleteAttribute, name, disabled, readOnly, rows, cols, autoFocus, spellCheck, autoComplete, onChange }: Props): JSX.Element;
    props: string[];
};
