...
`;
const Select = ({ selectId, name, multiple, onChange, children }) => (React.createElement(StyledSelect, { id: selectId, name: name, multiple: multiple, onChange: onChange }, children !== undefined ? (children) : (React.createElement(React.Fragment, null,
