...
const DateInputWithErrorOnDayInput = ({
  ...
  <StyledDiv>
    ...
    >
      ...
      <StyledSpan id={dobDayErrorHint}>For example, 31 3 1980</StyledSpan>
      <StyledSpan2 id={dobDayErrorError}>Error message goes here</StyledSpan2>
      <StyledDiv2 id={dobDayError}>
        <StyledDiv3>
          <StyledDiv4>
            <StyledLabel htmlFor={dobDayErrorDay}>Day</StyledLabel>
            <StyledInput
              id={dobDayErrorDay}
              name={name}
              pattern="[0-9]*"
        ...
        <StyledDiv5>
          <StyledDiv6>
            <StyledLabel2 htmlFor={dobDayErrorMonth}>Month</StyledLabel2>
            <StyledInput2
              id={dobDayErrorMonth}
              name={name2}
              pattern="[0-9]*"
        ...
        <StyledDiv7>
          <StyledDiv8>
            <StyledLabel3 htmlFor={dobDayErrorYear}>Year</StyledLabel3>
            <StyledInput3
              id={dobDayErrorYear}
              name={name3}
              pattern="[0-9]*"
