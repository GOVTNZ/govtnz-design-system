...
const StyledH5 = styled.h5 `
  ...
  ${props => props.marginBottom8 &&
    ...
    `}
`;
const H5 = ({ styleSize, marginBottom8, id, children }) => (React.createElement(StyledH5, { styleSize: styleSize, marginBottom8: marginBottom8, id: id }, children !== undefined ? (children) : (React.createElement(React.Fragment, null, "Example text"))));
