...
const StyledH1 = styled.h1<Pick<Props, "styleSize" | "marginBottom8">>`
  ${props =>
...
const H1 = ({ styleSize, marginBottom8, id, children }: Props) => (
  <StyledH1 styleSize={styleSize} marginBottom8={marginBottom8} id={id}>
    {children !== undefined ? (
      children
    ) : (
