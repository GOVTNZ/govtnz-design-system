...
`;
const SelectWithHintTextAndErrorMessage = ({ select2, select2Hint, select2Error, name, multiple, onChange }) => (React.createElement(StyledDiv, null,
    React.createElement(StyledLabel, { htmlFor: select2 }, "Label text goes here"),
    React.createElement(StyledSpan, { id: select2Hint }, "Hint text goes here"),
    React.createElement(StyledSpan2, { id: select2Error }, "Error message goes here"),
    React.createElement(StyledSelect, { "aria-describedby": select2Hint !== undefined || select2Error !== undefined
