...
type Props = {
  dobErrorsHint?: string | undefined;
  dobErrorsError?: string | undefined;
  dobErrors?: string | undefined;
  dobErrorsDay?: string | undefined;
  name: string;
  ...
  autoComplete:
    ...
    | "Photo";
  onChange: any;
  dobErrorsMonth?: string | undefined;
  name2: string;
  ...
  autoComplete2:
    ...
    | "Photo";
  onChange2: any;
  dobErrorsYear?: string | undefined;
  name3: string;
...
const DateInputWithErrors = ({
  ...
  <StyledDiv>
    ...
    >
      ...
      <StyledSpan id={dobErrorsHint}>For example, 31 3 1980</StyledSpan>
      <StyledSpan2 id={dobErrorsError}>Error message goes here</StyledSpan2>
      <StyledDiv2 id={dobErrors}>
        <StyledDiv3>
          <StyledDiv4>
            <StyledLabel htmlFor={dobErrorsDay}>Day</StyledLabel>
            <StyledInput
              id={dobErrorsDay}
              name={name}
              pattern="[0-9]*"
        ...
        <StyledDiv5>
          <StyledDiv6>
            <StyledLabel2 htmlFor={dobErrorsMonth}>Month</StyledLabel2>
            <StyledInput2
              id={dobErrorsMonth}
              name={name2}
              pattern="[0-9]*"
        ...
        <StyledDiv7>
          <StyledDiv8>
            <StyledLabel3 htmlFor={dobErrorsYear}>Year</StyledLabel3>
            <StyledInput3
              id={dobErrorsYear}
              name={name3}
              pattern="[0-9]*"
