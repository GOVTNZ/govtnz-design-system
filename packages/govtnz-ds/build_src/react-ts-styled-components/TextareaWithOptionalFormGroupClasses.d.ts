...
declare const TextareaWithOptionalFormGroupClasses: {
    ({ textareaWithPageHeading, name, disabled, readOnly, rows, cols, autoFocus, spellCheck, autoComplete, onChange }: Props): JSX.Element;
    props: string[];
};
