  ...
  <React.Fragment>
    {mode === "live" ? (
      <React.Fragment>
        {level === "info" ? (
          <React.Fragment>
            <StyledDiv aria-atomic="true" aria-live="polite" role="note">
              {children !== undefined ? (
                <React.Fragment>
    ...
    {mode === "live" ? (
      <React.Fragment>
        {level === "warning" ? (
          <React.Fragment>
            <StyledDiv3 aria-atomic="true" aria-live="polite" role="note">
              {children !== undefined ? (
                <React.Fragment>
    ...
    {mode === "live" ? (
      <React.Fragment>
        {level === "success" ? (
          <React.Fragment>
            <StyledDiv5 aria-atomic="true" aria-live="polite" role="note">
              {children !== undefined ? (
                <React.Fragment>
                ...
                <React.Fragment>
                  <StyledDiv8 level={level}>
                    ...
                    <StyledSvg4
                      ...
                      width="32"
                    >
                      <StyledPath4 d="M27.314 27.314c6.248-6.248 6.248-16.38 0-22.628-6.248-6.248-16.38-6.248-22.628 0-6.248 6.248-6.248 16.38 0 22.628 6.248 6.248 16.38 6.248 22.628 0zM14.21 7.175c.405-.878 1.35-1.35 2.297-1.114.911.236 1.52 1.114 1.452 2.093l-.102 1.892c-.134 2.364-.27 4.728-.372 7.058-.034.777-.675 1.385-1.452 1.385-.81 0-1.418-.608-1.453-1.452-.034-.473-.034-.946-.067-1.419-.101-1.52-.169-3.04-.27-4.593-.068-.98-.102-1.96-.17-2.938-.032-.27.002-.609.137-.912zM16 21.873c1.08 0 1.959.879 1.992 1.96 0 1.08-.879 1.959-1.96 1.959-1.047 0-1.958-.88-1.958-1.925-.033-1.082.845-1.994 1.926-1.994z" />
                    </StyledSvg4>
                  </StyledDiv8>
                </React.Fragment>
              ) : (
    ...
    {mode !== "live" ? (
      <React.Fragment>
        {level === "info" ? (
          <React.Fragment>
            <StyledDiv9 aria-labelledby={headingId} role="note">
              {children !== undefined ? (
                <React.Fragment>
                  <StyledDiv10 level={level}>
                    {children !== undefined ? (
                      children
                    ) : (
                      <React.Fragment> Example alert content </React.Fragment>
    ...
    {mode !== "live" ? (
      <React.Fragment>
        {level === "warning" ? (
          <React.Fragment>
            <StyledDiv11 aria-labelledby={headingId} role="note">
              {children !== undefined ? (
                <React.Fragment>
                  <StyledDiv12 level={level}>
                    {children !== undefined ? (
                      children
                    ) : (
                      <React.Fragment> Example alert content </React.Fragment>
                    ...
                    <StyledSvg6
                      ...
                      width="32"
                    >
                      <StyledPath6 d="M16.035 0c.746 0 1.424.387 1.778.995l13.95 26.233c.333.58.314 1.289-.05 1.851-.364.57-1.013.921-1.72.921H2.016c-.707 0-1.366-.349-1.73-.92-.362-.563-.383-1.273-.048-1.852L14.267.995C14.611.387 15.287 0 16.035 0zm-.006 22.938c-1.02 0-1.848.8-1.816 1.752 0 .92.86 1.691 1.847 1.691 1.019 0 1.847-.772 1.847-1.721-.031-.95-.86-1.722-1.878-1.722zm.477-14.015c-.892-.208-1.783.207-2.165.98-.127.266-.16.563-.128.8.063.86.095 1.722.159 2.583.096 1.366.159 2.701.255 4.037.03.415.03.831.063 1.247.033.742.606 1.276 1.37 1.276.732 0 1.337-.534 1.37-1.217.095-2.048.223-4.126.35-6.204l.096-1.662c.063-.86-.51-1.633-1.37-1.84z" />
                    </StyledSvg6>
                  </StyledDiv12>
                </React.Fragment>
              ) : (
    ...
    {mode !== "live" ? (
      <React.Fragment>
        {level === "success" ? (
          <React.Fragment>
            <StyledDiv13 aria-labelledby={headingId} role="note" tabIndex={-1}>
              {children !== undefined ? (
                <React.Fragment>
                  <StyledDiv14 level={level}>
                    {children !== undefined ? (
                      children
                    ) : (
                      <React.Fragment> Example alert content </React.Fragment>
    ...
    {mode !== "live" ? (
      <React.Fragment>
        {level === "error" ? (
          <React.Fragment>
            <StyledDiv15 aria-labelledby={headingId} role="note" tabIndex={-1}>
              {children !== undefined ? (
                <React.Fragment>
                  <StyledDiv16 level={level}>
                    {children !== undefined ? (
                      children
                    ) : (
                      <React.Fragment> Example alert content </React.Fragment>
                    ...
                    <StyledSvg8
                      ...
                      width="32"
                    >
                      <StyledPath8 d="M27.314 27.314c6.248-6.248 6.248-16.38 0-22.628-6.248-6.248-16.38-6.248-22.628 0-6.248 6.248-6.248 16.38 0 22.628 6.248 6.248 16.38 6.248 22.628 0zM14.21 7.175c.405-.878 1.35-1.35 2.297-1.114.911.236 1.52 1.114 1.452 2.093l-.102 1.892c-.134 2.364-.27 4.728-.372 7.058-.034.777-.675 1.385-1.452 1.385-.81 0-1.418-.608-1.453-1.452-.034-.473-.034-.946-.067-1.419-.101-1.52-.169-3.04-.27-4.593-.068-.98-.102-1.96-.17-2.938-.032-.27.002-.609.137-.912zM16 21.873c1.08 0 1.959.879 1.992 1.96 0 1.08-.879 1.959-1.96 1.959-1.047 0-1.958-.88-1.958-1.925-.033-1.082.845-1.994 1.926-1.994z" />
                    </StyledSvg8>
                  </StyledDiv16>
                </React.Fragment>
              ) : (
