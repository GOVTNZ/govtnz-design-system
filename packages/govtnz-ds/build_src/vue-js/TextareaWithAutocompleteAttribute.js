...
export default Vue.extend({
  ...
  render: new Function(
    'with(this){return _c(\'div\',{staticClass:"g-textareaWithAutocompleteAttribute-form-group"},[_c(\'label\',{staticClass:"g-textareaWithAutocompleteAttribute-label",attrs:{"for":textareaWithAutocompleteAttribute}},[_v("\\n\\n    Full address\\n  \\n\\n")]),_v(" "),_c(\'textarea\',{staticClass:"g-textareaWithAutocompleteAttribute-textarea",attrs:{"autocomplete":computed__autocomplete,"id":textareaWithAutocompleteAttribute,"name":name,"rows":rows,"disabled":disabled,"readonly":readOnly,"cols":cols,"autofocus":autoFocus,"spellcheck":spellCheck}})])}'
  )
});
