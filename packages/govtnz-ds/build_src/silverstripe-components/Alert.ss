<div aria-atomic="true" aria-live="polite" role="note"> 
        ...
        <div class="g-alert<% if $level == "info" %> g-alert--info<% else_if $level == "warning" %> g-alert--warning<% else_if $level == "success" %> g-alert--success<% else_if $level == "error" %> g-alert--error<% end_if %>"> 
          {$children}


          <svg aria-hidden="true" class="g-alert__icon" focusable="false" height="32" viewBox="0 0 32 32" width="32"> 
    ...
    <div aria-atomic="true" aria-live="polite" role="note"> 
        ...
        <div class="g-alert<% if $level == "info" %> g-alert--info<% else_if $level == "warning" %> g-alert--warning<% else_if $level == "success" %> g-alert--success<% else_if $level == "error" %> g-alert--error<% end_if %>"> 
          ...
          <svg aria-hidden="true" class="g-alert__icon" focusable="false" height="30" viewBox="0 0 32 30" width="32"> 
    ...
    <div<% if $headingId %> aria-labelledby="{$headingId}"<% end_if %> role="note"> 
      <div class="g-alert<% if $level == "info" %> g-alert--info<% else_if $level == "warning" %> g-alert--warning<% else_if $level == "success" %> g-alert--success<% else_if $level == "error" %> g-alert--error<% end_if %>"> 
        {$children}
    ...
    <div<% if $headingId %> aria-labelledby="{$headingId}"<% end_if %> role="note" tabindex="-1"> 
      <div class="g-alert<% if $level == "info" %> g-alert--info<% else_if $level == "warning" %> g-alert--warning<% else_if $level == "success" %> g-alert--success<% else_if $level == "error" %> g-alert--error<% end_if %>"> 
        {$children}
