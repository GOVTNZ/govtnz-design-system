...
var H3 = function H3(_ref) {
  ...
  return _react["default"].createElement("h3", {
    className: "${constants.styleSize[styleSize] !== undefined ? \" \" +  constants.styleSize[styleSize] : \"\"}".concat(marginBottom8 ? " g-h3-heading-mb-8" : "").concat(marginBottom0 ? " g-h3-heading-mb-0" : ""),
    id: id
