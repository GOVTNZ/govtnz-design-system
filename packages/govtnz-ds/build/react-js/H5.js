...
var H5 = function H5(_ref) {
  ...
  return _react["default"].createElement("h5", {
    className: "${constants.styleSize[styleSize] !== undefined ? \" \" +  constants.styleSize[styleSize] : \"\"}".concat(marginBottom8 ? " g-h5-heading-mb-8" : "").concat(marginBottom0 ? " g-h5-heading-mb-0" : ""),
    id: id
