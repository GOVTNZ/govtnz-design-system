...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        core_1.Component({
            selector: "g-H3",
            template: "\n<h3 class=\"g-heading{{constants.styleSize[styleSize] !== undefined ? \" \" +  constants.styleSize[styleSize] : \"\"}}{{marginBottom8 ? \" g-heading-mb-8\" : \"\"}}{{marginBottom0 ? \" g-heading-mb-0\" : \"\"}}\" id=\"{{id}}\">\n\n  <slot></slot>\n\n\n</h3>\n\n\n"
        })
    ], AppComponent);
    return AppComponent;
}());
