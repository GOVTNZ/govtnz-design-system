...
var StyledP = _styledComponents["default"].p(_templateObject(), function (props) {
  ...
  return props.styleSize === "small" && _styledComponents["default"].css(_templateObject4());
}, function (props) {
  return props.styleSize === "small" && _styledComponents["default"].css(_templateObject5());
}, function (props) {
  return props.styleSize === "small" && _styledComponents["default"].css(_templateObject6());
}, function (props) {
  return props.styleSize === "x-small" && _styledComponents["default"].css(_templateObject7());
}, function (props) {
  return props.styleSize === "x-small" && _styledComponents["default"].css(_templateObject8());
}, function (props) {
  return props.styleSize === "x-small" && _styledComponents["default"].css(_templateObject9());
});
