...
var StyledInput = _styledComponents["default"].input(_templateObject5());
...
var FileUploadWithErrorMessage = function FileUploadWithErrorMessage(_ref) {
  ...
  return _react["default"].createElement(StyledDiv, null, _react["default"].createElement(StyledLabel, {
    htmlFor: fileUpload3
  }, "Upload a file"), _react["default"].createElement(StyledSpan, {
    id: fileUpload3Hint
  }, "Your photo may be in your Pictures, Photos, Downloads or Desktop folder. Or in an app like iPhoto."), _react["default"].createElement(StyledSpan2, {
    id: fileUpload3Error
  }, "Error message goes here"), _react["default"].createElement(StyledInput, {
