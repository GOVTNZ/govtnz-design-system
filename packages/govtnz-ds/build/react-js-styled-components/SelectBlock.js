...
var StyledLabel = _styledComponents["default"].label(_templateObject());

var StyledSelect = _styledComponents["default"].select(_templateObject2(), function (props) {
  return props.hasError && _styledComponents["default"].css(_templateObject3());
});
...
var SelectBlock = function SelectBlock(_ref) {
  ...
  return _react["default"].createElement("div", null, _react["default"].createElement(StyledLabel, {
    htmlFor: selectId
