<div class="g-inputBlock-form-group<% if $error %>  g-inputBlock-form-group--error<% end_if %>"> 
  <label class="g-inputBlock-label"<% if $inputId %> for="{$inputId}"<% end_if %>> 
    {$label}
