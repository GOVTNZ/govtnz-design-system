...
var Button = function (_a) {
    ...
    return (react_1.default.createElement("button", { className: "g-button" + (disabled ? " g-button--disabled" : "") + (constants.level[level] !== undefined ? " " + constants.level[level] : ""), disabled: disabled !== undefined && disabled.toString() === "true", type: type, name: name, onClick: onClick }, children !== undefined ? (children) : (react_1.default.createElement(react_1.default.Fragment, null, " Example text "))));
};
