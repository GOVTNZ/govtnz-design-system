...
var Button = function (_a) {
    ...
    return (react_1.default.createElement("button", { className: "g-button" + (disabled ? " g-button--disabled" : "") + (constants.level[level] !== undefined ? " " + constants.level[level] : ""), disabled: disabled !== undefined ? disabled.toString() === "true" : undefined, type: type, name: name, onClick: onClick },
        " ",
