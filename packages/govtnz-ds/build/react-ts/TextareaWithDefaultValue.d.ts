...
declare const TextareaWithDefaultValue: ({ fullAddress, name, disabled, readOnly, rows, cols, autoFocus, spellCheck, autoComplete, value, onChange }: Props) => JSX.Element;
