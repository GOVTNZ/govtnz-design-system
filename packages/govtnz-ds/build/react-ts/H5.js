...
var H5 = function (_a) {
    ...
    return (React.createElement("h5", { className: "" + (constants.styleSize[styleSize] !== undefined
            ...
            : "") + (marginBottom8 ? " g-h5-heading-mb-8" : "") + (marginBottom0 ? " g-h5-heading-mb-0" : ""), id: id }, children !== undefined ? (children) : (React.createElement(React.Fragment, null, "Example text"))));
};
exports.default = H5;
