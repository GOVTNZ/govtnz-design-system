...
var H3 = function (_a) {
    ...
    return (React.createElement("h3", { className: "${constants.styleSize[styleSize] !== undefined ? \" \" +  constants.styleSize[styleSize] : \"\"}" + (marginBottom8 ? " g-h3-heading-mb-8" : "") + (marginBottom0 ? " g-h3-heading-mb-0" : ""), id: id }, children !== undefined ? (children) : (React.createElement(React.Fragment, null, "Example text"))));
};
exports.default = H3;
