...
var H4 = function (_a) {
    ...
    return (React.createElement("h4", { className: "" + (constants.styleSize[styleSize] !== undefined
            ...
            : "") + (marginBottom8 ? " g-h4-heading-mb-8" : "") + (marginBottom0 ? " g-h4-heading-mb-0" : ""), id: id }, children !== undefined ? (children) : (React.createElement(React.Fragment, null, "Example text"))));
};
exports.default = H4;
