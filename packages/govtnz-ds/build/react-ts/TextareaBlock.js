...
var TextareaBlock = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "g-textareaBlock-form-group" + (errorId ? " g-textareaBlock-form-group--error" : "") },
        " ",
        react_1.default.createElement("label", { className: "g-textareaBlock-label", htmlFor: id },
            " ",
        ...
        hintId !== undefined ? (react_1.default.createElement(react_1.default.Fragment, null,
            " ",
            react_1.default.createElement("div", { className: "g-textareaBlock-hint", id: hintId },
                " ",
        ...
        react_1.default.createElement("textarea", { "aria-describedby": hintId !== undefined || errorId !== undefined
                ...
                : undefined, className: "g-textareaBlock-textarea", id: id, name: name, rows: rows, disabled: disabled !== undefined ? disabled.toString() === "true" : undefined, readOnly: readOnly, cols: cols, autoFocus: autoFocus, spellCheck: spellCheck, autoComplete: autoComplete, maxLength: maxLength, value: value, onChange: onChange, ref: ref }),
        " "));
};
