...
var FooterStandard = function (_a) {
    var href = _a.href, rel = _a.rel, target = _a.target, label1 = _a.label1, href2 = _a.href2, rel2 = _a.rel2, target2 = _a.target2, label2 = _a.label2, href3 = _a.href3, rel3 = _a.rel3, target3 = _a.target3, label3 = _a.label3, href4 = _a.href4, rel4 = _a.rel4, target4 = _a.target4, href5 = _a.href5, rel5 = _a.rel5, target5 = _a.target5, src = _a.src, width = _a.width, height = _a.height, srcSet = _a.srcSet, crossOrigin = _a.crossOrigin, copyrightYear = _a.copyrightYear;
    return (React.createElement("div", { className: "g-footer__standard" },
        React.createElement("div", { className: "g-flex-container" },
            React.createElement("div", { className: "g-flex-row" },
                React.createElement("div", { className: "g-flex-col g-flex-col-xs-12 g-flex-col-sm-10 g-flex-col-md-10 g-flex-col-lg-10" },
                    React.createElement("div", { className: "g-footer__standard-item" },
                        React.createElement("ul", { className: "g-footer__standard-inline-list" },
                            React.createElement("li", { className: "g-footer__standard-inline-list-item" },
                                React.createElement("a", { className: "g-footer__standard-link", href: href, rel: rel, target: constants.target[target] }, label1 !== undefined ? (label1) : (React.createElement(React.Fragment, null, "Contact")))),
                            React.createElement("li", { className: "g-footer__standard-inline-list-item" },
                                React.createElement("a", { className: "g-footer__standard-link", href: href2, rel: rel2, target: constants.target2[target2] }, label2 !== undefined ? (label2) : (React.createElement(React.Fragment, null, "Privacy")))),
                            React.createElement("li", { className: "g-footer__standard-inline-list-item" },
                                React.createElement("a", { className: "g-footer__standard-link", href: href3, rel: rel3, target: constants.target3[target3] }, label3 !== undefined ? (label3) : (React.createElement(React.Fragment, null, "Copyright")))))))),
            React.createElement("div", { className: "g-flex-row" },
                React.createElement("div", { className: "g-flex-col g-flex-col-xs-12 g-flex-col-sm-8 g-flex-col-md-10 g-flex-col-lg-9" },
                    React.createElement("a", { className: "g-footer__standard-link--plain", href: href4, rel: rel4, target: constants.target4[target4] },
                        React.createElement("span", { className: "g-footer-visually-hidden" }, "New Zealand Government"),
                        React.createElement("svg", { className: "g-footer__icon-govt-logo", focusable: "false", height: "24", role: "presentation", width: "230", xmlns: "http://www.w3.org/2000/svg" },
                    ...
                    React.createElement("div", { className: "g-footer__standard-licence" },
                        React.createElement("p", null,
                            React.createElement("a", { className: "g-footer__standard-link--plain", href: href5, rel: rel5, target: constants.target5[target5] },
                                React.createElement("span", { className: "g-footer-visually-hidden" }, "Creative Commons 4.0 International Licence"),
                                React.createElement("svg", { className: "g-footer__icon-cc", focusable: "false", height: "32", role: "presentation", width: "32", xmlns: "http://www.w3.org/2000/svg" },
                                    React.createElement("path", { d: "M16 0c4.4 0 8.3 1.6 11.4 4.7a15.4 15.4 0 0 1 3.4 5.1 16.3 16.3 0 0 1 0 12.4 14.7 14.7 0 0 1-3.4 5 16.4 16.4 0 0 1-5.3 3.6A16 16 0 0 1 16 32a15.6 15.6 0 0 1-6.1-1.2A16.1 16.1 0 0 1 4.7 4.7C7.7 1.6 11.5 0 16 0zm0 2.9c-3.6 0-6.7 1.3-9.2 3.8A13.8 13.8 0 0 0 3.9 11a12.6 12.6 0 0 0-1 5c0 1.7.3 3.4 1 5a13.3 13.3 0 0 0 2.9 4.2 13.2 13.2 0 0 0 4.3 2.9 12.8 12.8 0 0 0 10 0 13.8 13.8 0 0 0 4.3-3c2.5-2.4 3.7-5.4 3.7-9.1 0-1.8-.3-3.4-1-5a12.8 12.8 0 0 0-2.8-4.3A12.7 12.7 0 0 0 16 3zm-.2 10.4l-2.1 1.2c-.2-.5-.5-.9-.9-1l-.9-.3c-1.4 0-2.1 1-2.1 2.8 0 .9.2 1.5.5 2 .4.6 1 .8 1.6.8 1 0 1.6-.4 2-1.3l2 1a4.7 4.7 0 0 1-1.8 1.8 4.7 4.7 0 0 1-2.4.7c-1.5 0-2.6-.5-3.5-1.3A5 5 0 0 1 6.9 16a5 5 0 0 1 1.3-3.6c.9-1 2-1.4 3.4-1.4 2 0 3.4.8 4.2 2.3zm9.3 0l-2.2 1.2c-.2-.5-.5-.9-.8-1a2 2 0 0 0-1-.3c-1.4 0-2.1 1-2.1 2.8 0 .9.2 1.5.5 2 .4.6 1 .8 1.6.8 1 0 1.6-.4 2-1.3l2 1a5 5 0 0 1-1.8 1.8 4.6 4.6 0 0 1-2.4.7c-1.4 0-2.6-.5-3.5-1.3a5 5 0 0 1-1.3-3.7 5 5 0 0 1 1.4-3.6c.9-1 2-1.4 3.3-1.4 2 0 3.4.8 4.3 2.3z", fill: "currentColor" })),
                                React.createElement("svg", { className: "g-footer__icon-cc", focusable: "false", height: "32", role: "presentation", width: "32", xmlns: "http://www.w3.org/2000/svg" },
                                    React.createElement("path", { d: "M16 .2c4.4 0 8.1 1.6 11.2 4.6 3 3 4.6 6.8 4.6 11.2 0 4.4-1.5 8.1-4.5 11-3.2 3.2-7 4.8-11.3 4.8-4.3 0-8-1.6-11.1-4.7C1.8 24.1.2 20.3.2 16S1.8 8 5 4.8c3-3 6.7-4.6 11-4.6zm0 2.9c-3.6 0-6.6 1.2-9 3.8A12.7 12.7 0 0 0 7 25a12.6 12.6 0 0 0 18.3 0 12 12 0 0 0 3.6-9.1c0-3.6-1.2-6.6-3.8-9.1a12.4 12.4 0 0 0-9-3.8zm4.2 9v6.4h-1.8v7.7h-4.8v-7.7h-1.8v-6.4c0-.3 0-.5.2-.7a1 1 0 0 1 .8-.3h6.4a1 1 0 0 1 .7.3c.2.2.3.4.3.7zm-6.4-4c0-1.5.7-2.3 2.2-2.3s2.2.8 2.2 2.2c0 1.5-.7 2.2-2.2 2.2s-2.2-.7-2.2-2.2z", fill: "currentColor" })))),
                        React.createElement("p", { className: "g-footer__standard-small-text" }, "Unless indicated otherwise, all content on Govt.nz is licensed for re-use under a Creative Commons 4.0 International Licence"))),
                React.createElement("div", { className: "g-flex-col g-flex-col-xs-12 g-flex-col-sm-4 g-flex-col-md-2 g-flex-col-lg-3" },
                    React.createElement("div", { className: "g-footer__standard-copyright" },
                        React.createElement("img", { alt: "New Zealand Coat of Arms", className: "g-footer__image-coat-of-arms", src: src, width: width, height: height, srcSet: srcSet, crossOrigin: constants.crossOrigin[crossOrigin] }),
                        React.createElement("p", { className: "g-footer__standard-small-text" },
                            "\u00A9 Crown Copyright",
                            " ",
