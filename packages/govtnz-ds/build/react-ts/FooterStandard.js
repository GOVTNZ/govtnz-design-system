...
var FooterStandard = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "g-footer__standard" },
        " ",
        react_1.default.createElement("div", { className: "g-flex-container" },
            " ",
            react_1.default.createElement("div", { className: "g-flex-row" },
                " ",
                react_1.default.createElement("div", { className: "g-flex-col g-flex-col-xs-12 g-flex-col-sm-10 g-flex-col-md-10 g-flex-col-lg-10" },
                    " ",
                    react_1.default.createElement("div", { className: "g-footer__standard-item" },
                        " ",
                        react_1.default.createElement("ul", { className: "g-footer__standard-inline-list" },
                            " ",
                            react_1.default.createElement("li", { className: "g-footer__standard-inline-list-item" },
                                " ",
                                react_1.default.createElement("a", { className: "g-footer__standard-link", href: href, rel: rel, target: target, onClick: onClick }, label1 !== undefined ? (label1) : (react_1.default.createElement(react_1.default.Fragment, null, "Contact"))),
                                " "),
                            " ",
                            react_1.default.createElement("li", { className: "g-footer__standard-inline-list-item" },
                                " ",
                                react_1.default.createElement("a", { className: "g-footer__standard-link", href: href, rel: rel, target: target, onClick: onClick }, label2 !== undefined ? (label2) : (react_1.default.createElement(react_1.default.Fragment, null, "Privacy"))),
                                " "),
                            " ",
                            react_1.default.createElement("li", { className: "g-footer__standard-inline-list-item" },
                                " ",
                                react_1.default.createElement("a", { className: "g-footer__standard-link", href: href, rel: rel, target: target, onClick: onClick }, label3 !== undefined ? (label3) : (react_1.default.createElement(react_1.default.Fragment, null, "Copyright"))),
                                " "),
                            " "),
                        " "),
                    " "),
            ...
            react_1.default.createElement("div", { className: "g-flex-row" },
                " ",
                react_1.default.createElement("div", { className: "g-flex-col g-flex-col-xs-12 g-flex-col-sm-8 g-flex-col-md-10 g-flex-col-lg-9" },
                    " ",
                    react_1.default.createElement("a", { className: "g-footer__standard-link--plain", href: href, rel: rel, target: target, onClick: onClick },
                        " ",
                        react_1.default.createElement("span", { className: "g-footer-visually-hidden" }, "New Zealand Government"),
                        " ",
                        react_1.default.createElement("svg", { className: "g-footer__icon-govt-logo", focusable: "false", height: "24", role: "presentation", width: "230", xmlns: "http://www.w3.org/2000/svg" },
                            " ",
                        ...
                        " "),
                    " ",
                    react_1.default.createElement("div", { className: "g-footer__standard-licence" },
                        " ",
                        react_1.default.createElement("p", null,
                            " ",
                            react_1.default.createElement("a", { className: "g-footer__standard-link--plain", href: href, rel: rel, target: target, onClick: onClick },
                                " ",
                                react_1.default.createElement("span", { className: "g-footer-visually-hidden" }, "Creative Commons 4.0 International Licence"),
                                " ",
                                react_1.default.createElement("svg", { className: "g-footer__icon-cc", focusable: "false", height: "32", role: "presentation", width: "32", xmlns: "http://www.w3.org/2000/svg" },
                                    " ",
                            ...
                            " "),
                        " ",
                        react_1.default.createElement("p", { className: "g-footer__standard-small-text" }, "Unless indicated otherwise, all content on Govt.nz is licensed for re-use under a Creative Commons 4.0 International Licence"),
                        " "),
                    " "),
                " ",
                react_1.default.createElement("div", { className: "g-flex-col g-flex-col-xs-12 g-flex-col-sm-4 g-flex-col-md-2 g-flex-col-lg-3" },
                    " ",
                    react_1.default.createElement("div", { className: "g-footer__standard-copyright" },
                        " ",
                        react_1.default.createElement("img", { alt: "New Zealand Coat of Arms", className: "g-footer__image-coat-of-arms", src: src, width: width, height: height, srcSet: srcset, crossOrigin: crossorigin }),
                        " ",
                        react_1.default.createElement("p", { className: "g-footer__standard-small-text" },
                            "\u00A9 Crown Copyright",
                            " ",
