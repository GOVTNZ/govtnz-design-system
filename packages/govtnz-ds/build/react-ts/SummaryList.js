    ...
    return (React.createElement("dl", { className: "g-summary-list" },
            ...
            React.createElement("dd", { className: "g-summary-list__actions" },
                React.createElement("ul", { className: "g-summary-list__actions-list" },
                    React.createElement("li", { className: "g-summary-list__actions-list-item" },
                        React.createElement("a", { className: "g-link", href: href, rel: rel, target: constants.target[target] },
                            "Edit",
                            React.createElement("span", { className: "g-summaryList-visually-hidden" }, " name"))),
                    React.createElement("li", { className: "g-summary-list__actions-list-item" },
                        React.createElement("a", { className: "g-link", href: href2, rel: rel2, target: constants.target2[target2] },
                            "Delete",
                            React.createElement("span", { className: "g-summaryList-visually-hidden" }, " name")))))),
        React.createElement("div", { className: "g-summary-list__row" },
            ...
            React.createElement("dd", { className: "g-summary-list__actions" },
                React.createElement("a", { className: "g-link", href: href3, rel: rel3, target: constants.target3[target3] },
                    "Change",
        ...
        React.createElement("div", { className: "g-summary-list__row" },
            ...
            React.createElement("dd", { className: "g-summary-list__actions" },
                React.createElement("ul", { className: "g-summary-list__actions-list" },
                    React.createElement("li", { className: "g-summary-list__actions-list-item" },
                        React.createElement("a", { className: "g-link", href: href4, rel: rel4, target: constants.target4[target4] },
                            "Edit",
                            React.createElement("span", { className: "g-summaryList-visually-hidden" },
                                " ",
                                "contact information"))),
                    React.createElement("li", { className: "g-summary-list__actions-list-item" },
                        React.createElement("a", { className: "g-link", href: href5, rel: rel5, target: constants.target5[target5] },
                            "Change",
