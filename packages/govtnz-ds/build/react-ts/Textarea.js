...
var Textarea = function (_a) {
    ...
    return (React.createElement("div", { className: "g-textarea-form-group" },
        ...
        React.createElement("textarea", { "aria-describedby": moreDetailHint, className: "g-textarea", id: moreDetail, name: name, rows: rows, disabled: disabled, readOnly: readOnly, cols: cols, autoFocus: autoFocus, spellCheck: spellCheck, autoComplete: constants.autoComplete[autoComplete], value: value, onChange: onChange })));
};
