  ...
  <div className="g-footer__standard">
    <div className="g-flex-container">
      <div className="g-flex-row">
        <div className="g-flex-col g-flex-col-xs-12 g-flex-col-sm-10 g-flex-col-md-10 g-flex-col-lg-10">
      ...
      <div className="g-flex-row">
        ...
        <div className="g-flex-col g-flex-col-xs-12 g-flex-col-sm-4 g-flex-col-md-2 g-flex-col-lg-3">
