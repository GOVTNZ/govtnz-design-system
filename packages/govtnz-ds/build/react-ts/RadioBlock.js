...
var RadioBlock = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "g-radios__item" + (errorId ? " g-form-group--error" : "") },
        " ",
        ...
        " ",
        react_1.default.createElement("label", { className: "g-label g-radios__label", htmlFor: id },
            " ",
        ...
        hintId !== undefined ? (react_1.default.createElement(react_1.default.Fragment, null,
            " ",
            react_1.default.createElement("div", { className: "g-hint g-checkboxes__hint", id: hintId },
                " ",
