...
var RadioBlock = function (_a) {
    var radioId = _a.radioId, hintId = _a.hintId, disabled = _a.disabled, readOnly = _a.readOnly, autoFocus = _a.autoFocus, gov = _a.gov, value = _a.value, checked = _a.checked, onChange = _a.onChange, label = _a.label, hint = _a.hint;
    return (React.createElement("div", { className: "g-radios__item" },
        React.createElement("input", { "aria-describedby": hintId, className: "g-radios__input", id: radioId, name: gov, type: "radio", disabled: disabled, readOnly: readOnly, autoFocus: autoFocus, value: value, checked: checked, onChange: onChange }),
