...
var RadioBlock = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "g-radios__item" + (errorId ? " g-radioBlock-form-group--error" : "") },
        react_1.default.createElement("input", { "aria-describedby": hintId, className: "g-radios__input", id: id, name: name, type: "radio", disabled: disabled, readOnly: readOnly, autoFocus: autoFocus, value: value, checked: checked, onChange: onChange, ref: ref }),
