...
var RadioBlock = function (_a) {
    var errorId = _a.errorId, id = _a.id, hintId = _a.hintId, disabled = _a.disabled, readOnly = _a.readOnly, autoFocus = _a.autoFocus, name = _a.name, value = _a.value, checked = _a.checked, onChange = _a.onChange, label = _a.label, hint = _a.hint;
    return (React.createElement("div", { className: "g-radios__item" + (errorId ? " g-radioBlock-form-group--error" : "") },
