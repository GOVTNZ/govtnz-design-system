...
var DateInput = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "g-dateInput-form-group" + (errorId ? " g-dateInput-form-group--error" : "") },
        ...
        react_1.default.createElement("fieldset", { "aria-describedby": hintId !== undefined || errorId !== undefined
            ...
            " ",
            react_1.default.createElement("legend", { className: "g-dateInput-fieldset__legend" },
                " ",
                label !== undefined ? (label) : (react_1.default.createElement(react_1.default.Fragment, null, "Example label")),
                " "),
            " ",
            react_1.default.createElement("span", { className: "g-dateInput-hint", id: hintId },
                " ",
            ...
            react_1.default.createElement("div", { className: "g-dateInput", id: id },
                ...
                react_1.default.createElement("div", { className: "g-dateInput__item" },
                    ...
                    react_1.default.createElement("div", { className: "g-dateInput-form-group" },
                        " ",
                        react_1.default.createElement("label", { className: "g-dateInput-label g-dateInput__label", htmlFor: dayId },
                            " ",
                            "Day",
                            " "),
                        " ",
                        react_1.default.createElement("input", { className: "g-dateInput-input g-dateInput__input g-dateInput-input--width-2" + (error ? " g-dateInput-input--error" : ""), id: dayId, maxLength: 2, name: dayName, pattern: "[0-9]*", type: "text", value: value, disabled: disabled !== undefined
                ...
                react_1.default.createElement("div", { className: "g-dateInput__item" },
                    ...
                    react_1.default.createElement("div", { className: "g-dateInput-form-group" },
                        " ",
                        react_1.default.createElement("label", { className: "g-dateInput-label g-dateInput__label", htmlFor: monthId },
                            " ",
                            "Month",
                            " "),
                        " ",
                        react_1.default.createElement("input", { className: "g-dateInput-input g-dateInput__input g-dateInput-input--width-2" + (error ? " g-dateInput-input--error" : ""), id: monthId, maxLength: 2, name: yearName, pattern: "[0-9]*", type: "text", value: value2, disabled: disabled !== undefined
                                ? disabled.toString() === "true"
                ...
                react_1.default.createElement("div", { className: "g-dateInput__item" },
                    ...
                    react_1.default.createElement("div", { className: "g-dateInput-form-group" },
                        " ",
                        react_1.default.createElement("label", { className: "g-dateInput-label g-dateInput__label", htmlFor: yearId },
                            " ",
                            "Year",
                            " "),
                        " ",
                        react_1.default.createElement("input", { className: "g-dateInput-input g-dateInput__input g-dateInput-input--width-4" + (error ? " g-dateInput-input--error" : ""), id: yearId, maxLength: 4, name: yearName, pattern: "[0-9]*", type: "text", value: value3, disabled: disabled !== undefined
                                ? disabled.toString() === "true"
