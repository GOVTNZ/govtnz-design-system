...
var MainNavItem = function (_a) {
    ...
    return (react_1.default.createElement("li", { className: "g-main-nav__item" },
        react_1.default.createElement("a", { "aria-current": ariaCurrent, className: "g-main-nav__item__link", href: href, rel: rel, target: target, onClick: onClick }, children !== undefined ? (children) : (react_1.default.createElement(react_1.default.Fragment, null, " Example item text ")))));
};
