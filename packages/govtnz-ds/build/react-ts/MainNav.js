...
var MainNav = function (_a) {
    var isOpen = _a.isOpen, id = _a.id, navId = _a.navId, name = _a.name, type = _a.type, onClick = _a.onClick, button = _a.button, children = _a.children;
    return (react_1.default.createElement("nav", { "aria-label": "Main", className: "g-main-nav", role: "navigation" },
        react_1.default.createElement("button", { "aria-controls": navId, "aria-expanded": isOpen !== undefined ? isOpen.toString() === "true" : undefined, className: "g-main-nav__button" + (constants.isOpen[isOpen] !== undefined
                ? " " + constants.isOpen[isOpen]
                : ""), id: id, name: name, type: type, onClick: onClick },
