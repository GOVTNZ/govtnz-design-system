...
declare const InputBlock: ({ error, inputId, label, hint, hintId, errorId, width, hasError, name, disabled, readOnly, autoFocus, value, type, spellCheck, maxLength, autoComplete, onChange }: Props) => JSX.Element;
