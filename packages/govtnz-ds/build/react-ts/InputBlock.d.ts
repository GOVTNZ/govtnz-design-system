...
declare const InputBlock: ({ hasError, inputId, label, hintId, hint, errorId, error, width, name, disabled, readOnly, autoFocus, value, type, spellCheck, maxLength, autoComplete, onChange }: Props) => JSX.Element;
