...
var TextareaWithErrorMessage = function (_a) {
    ...
    return (React.createElement("div", { className: "g-textareaWithErrorMessage-form-group g-textareaWithErrorMessage-form-group--error" },
        ...
        React.createElement("textarea", { "aria-describedby": noNiReasonError, className: "g-textareaWithErrorMessage-textarea g-textareaWithErrorMessage-textarea--error", id: noNiReason, name: name, rows: rows, disabled: disabled, readOnly: readOnly, cols: cols, autoFocus: autoFocus, spellCheck: spellCheck, autoComplete: constants.autoComplete[autoComplete], maxLength: maxLength, value: value, onChange: onChange })));
};
