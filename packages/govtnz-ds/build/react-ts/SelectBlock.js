...
var SelectBlock = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: errorId ? "g-selectBlock-form-group--error" : "" },
        ...
        react_1.default.createElement("select", { className: "g-selectBlock-select" + (error ? " g-selectBlock-select--error" : ""), id: selectId, name: name, multiple: multiple, onChange: onChange, ref: ref }, children !== undefined ? (children) : (react_1.default.createElement(react_1.default.Fragment, null,
