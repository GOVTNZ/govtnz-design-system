...
var InputBlock = function (_a) {
    ...
    return (React.createElement("div", { className: "g-inputBlock-form-group" + (errorId ? " g-inputBlock-form-group--error" : "") },
        React.createElement("label", { className: "g-inputBlock-label", htmlFor: id }, label !== undefined ? (label) : (React.createElement(React.Fragment, null, "Example text"))),
