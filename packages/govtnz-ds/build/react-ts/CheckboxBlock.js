...
var CheckboxBlock = function (_a) {
    var fakeFocus = _a.fakeFocus, checkboxId = _a.checkboxId, hintId = _a.hintId, name = _a.name, disabled = _a.disabled, readOnly = _a.readOnly, autoFocus = _a.autoFocus, value = _a.value, checked = _a.checked, onChange = _a.onChange, label = _a.label, hint = _a.hint;
