...
const SelectWithHintTextAndErrorMessage = ({ select2, select2Hint, select2Error, name, multiple, onChange }) => (React.createElement("div", { className: "g-selectWithHintTextAndErrorMessage-form-group g-selectWithHintTextAndErrorMessage-form-group--error" },
