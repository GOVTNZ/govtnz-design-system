...
`;
const Textarea = ({ moreDetail, moreDetailHint, onChange }) => (React.createElement(StyledDiv, null,
    ...
    React.createElement(StyledTextarea, { "aria-describedby": moreDetailHint, id: moreDetail, name: "more-detail", rows: "5", onChange: onChange })));
