...
`;
const TextareaWithAutocompleteAttribute = ({ textareaWithAutocompleteAttribute, onChange }) => (React.createElement(StyledDiv, null,
    React.createElement(StyledLabel, { htmlFor: textareaWithAutocompleteAttribute }, "Full address"),
    React.createElement(StyledTextarea, { autoComplete: "street-address", id: textareaWithAutocompleteAttribute, name: "address", rows: "5", onChange: onChange })));
