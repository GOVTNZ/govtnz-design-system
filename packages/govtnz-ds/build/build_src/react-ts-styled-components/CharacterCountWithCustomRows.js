...
const StyledSpan = styled.span `
  ...
  margin-bottom: 0;
`;
const CharacterCountWithCustomRows = ({ customRows, onChange, customRowsInfo }) => (React.createElement(StyledDiv, { "data-maxlength": "10", "data-module": "character-count" },
    React.createElement(StyledDiv2, null,
        React.createElement(StyledLabel, { htmlFor: customRows }, "Full address"),
        React.createElement(StyledTextarea, { id: customRows, name: "custom", rows: "8", onChange: onChange }),
