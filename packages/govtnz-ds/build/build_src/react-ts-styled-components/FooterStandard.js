...
const FooterStandard = ({ href, rel, target, label1, href2, rel2, target2, label2, href3, rel3, target3, label3, href4, rel4, target4, href5, rel5, target5, src, width, height, srcSet, crossOrigin, copyrightYear }) => (React.createElement(StyledDiv, null,
                ...
                React.createElement(StyledDiv2, null,
                    React.createElement(StyledUl, null,
                        React.createElement(StyledLi, null,
                            React.createElement(StyledA, { href: href, rel: rel, target: constants.target[target] }, label1 !== undefined ? (label1) : (React.createElement(React.Fragment, null, "Contact")))),
                        React.createElement(StyledLi2, null,
                            React.createElement(StyledA2, { href: href2, rel: rel2, target: constants.target2[target2] }, label2 !== undefined ? (label2) : (React.createElement(React.Fragment, null, "Privacy")))),
                        React.createElement(StyledLi3, null,
                            React.createElement(StyledA3, { href: href3, rel: rel3, target: constants.target3[target3] }, label3 !== undefined ? (label3) : (React.createElement(React.Fragment, null, "Copyright")))))))),
        React.createElement("div", null,
            React.createElement("div", null,
                React.createElement(StyledA4, { href: href4, rel: rel4, target: constants.target4[target4] },
                    React.createElement(StyledSpan, null, "New Zealand Government"),
                    React.createElement(StyledSvg, { focusable: "false", height: "24", role: "presentation", width: "230", xmlns: "http://www.w3.org/2000/svg" },
                ...
                React.createElement(StyledDiv3, null,
                    React.createElement("p", null,
                        React.createElement(StyledA5, { href: href5, rel: rel5, target: constants.target5[target5] },
                            React.createElement(StyledSpan2, null, "Creative Commons 4.0 International Licence"),
                            React.createElement("svg", { focusable: "false", height: "32", role: "presentation", width: "32", xmlns: "http://www.w3.org/2000/svg" },
                    ...
                    React.createElement(StyledP, null, "Unless indicated otherwise, all content on Govt.nz is licensed for re-use under a Creative Commons 4.0 International Licence"))),
            React.createElement("div", null,
                React.createElement(StyledDiv4, null,
                    React.createElement(StyledImg, { alt: "New Zealand Coat of Arms", src: src, width: width, height: height, srcSet: srcSet, crossOrigin: constants.crossOrigin[crossOrigin] }),
