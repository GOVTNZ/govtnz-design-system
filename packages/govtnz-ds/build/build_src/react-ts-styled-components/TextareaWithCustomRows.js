...
`;
const TextareaWithCustomRows = ({ fullAddress, onChange }) => (React.createElement(StyledDiv, null,
    React.createElement(StyledLabel, { htmlFor: fullAddress }, "Full address"),
    React.createElement(StyledTextarea, { id: fullAddress, name: "address", rows: "8", onChange: onChange })));
