...
`;
const TextareaWithDefaultValue = ({ fullAddress, onChange }) => (React.createElement(StyledDiv, null,
    React.createElement(StyledLabel, { htmlFor: fullAddress }, "Full address"),
    React.createElement(StyledTextarea, { id: fullAddress, name: "address", rows: "5", onChange: onChange }, "221B Baker Street London NW1 6XE")));
