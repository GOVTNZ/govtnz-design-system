...
`;
const TextareaWithLabelAsPageHeading = ({ textareaWithPageHeading, onChange }) => (React.createElement(StyledDiv, null,
    React.createElement(StyledH1, null,
        React.createElement(StyledLabel, { htmlFor: textareaWithPageHeading }, "Full address")),
    React.createElement(StyledTextarea, { id: textareaWithPageHeading, name: "address", rows: "5", onChange: onChange })));
