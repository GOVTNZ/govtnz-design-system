...
var _default = _vue["default"].extend({
  ...
  render: new Function('with(this){return _c(\'div\',{staticClass:"g-characterCountWithCustomRows-character-count"},[_c(\'div\',{staticClass:"g-characterCountWithCustomRows-form-group"},[_c(\'label\',{staticClass:"g-characterCountWithCustomRows-label",attrs:{"for":id}},[_v("\\n\\n          Full address\\n        \\n\\n")]),_v(" "),_c(\'textarea\',{staticClass:"g-characterCountWithCustomRows-textarea",attrs:{"id":id,"name":name,"rows":rows,"disabled":disabled,"readonly":readOnly,"cols":cols,"autofocus":autoFocus,"spellcheck":spellCheck,"autocomplete":computed__autocomplete,"maxlength":maxLength},domProps:{"value":value}}),_v(" "),_c(\'span\',{staticClass:"g-characterCountWithCustomRows-hint g-characterCountWithCustomRows-character-count__message",attrs:{"aria-atomic":"true","aria-live":"polite"}},[_v("\\nYou have "),_t("remainingCharacters"),_v(" characters remaining\\n\\n")],2)])])}')
});
