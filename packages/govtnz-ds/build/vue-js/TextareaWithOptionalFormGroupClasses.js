...
var _default = _vue["default"].extend({
  ...
  render: new Function('with(this){return _c(\'div\',{staticClass:"g-textareaWithOptionalFormGroupClasses-form-group extra-class"},[_c(\'label\',{staticClass:"g-textareaWithOptionalFormGroupClasses-label",attrs:{"for":textareaWithPageHeading}},[_v("\\n\\n    Full address\\n  \\n\\n")]),_v(" "),_c(\'textarea\',{staticClass:"g-textareaWithOptionalFormGroupClasses-textarea",attrs:{"id":textareaWithPageHeading,"name":name,"rows":rows,"disabled":disabled,"readonly":readOnly,"cols":cols,"autofocus":autoFocus,"spellcheck":spellCheck,"autocomplete":computed__autocomplete}})])}')
});
