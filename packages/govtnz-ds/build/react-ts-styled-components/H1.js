...
const StyledH1 = styled.h1 `
  ...
  ${props => props.marginBottom8 &&
    ...
    `}
`;
const H1 = ({ styleSize, marginBottom8, id, children }) => (React.createElement(StyledH1, { styleSize: styleSize, marginBottom8: marginBottom8, id: id }, children !== undefined ? (children) : (React.createElement(React.Fragment, null, "Example text"))));
