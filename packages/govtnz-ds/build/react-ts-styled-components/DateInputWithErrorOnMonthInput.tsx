...
type Props = {
  dobMonthErrorHint?: string | undefined;
  dobMonthErrorError?: string | undefined;
  dobMonthError?: string | undefined;
  dobMonthErrorDay?: string | undefined;
  name: string;
  ...
  autoComplete:
    ...
    | "Photo";
  onChange: any;
  dobMonthErrorMonth?: string | undefined;
  name2: string;
  ...
  autoComplete2:
    ...
    | "Photo";
  onChange2: any;
  dobMonthErrorYear?: string | undefined;
  name3: string;
...
const DateInputWithErrorOnMonthInput = ({
  ...
  <StyledDiv>
    ...
    >
      ...
      <StyledSpan id={dobMonthErrorHint}>For example, 31 3 1980</StyledSpan>
      <StyledSpan2 id={dobMonthErrorError}>Error message goes here</StyledSpan2>
      <StyledDiv2 id={dobMonthError}>
        <StyledDiv3>
          <StyledDiv4>
            <StyledLabel htmlFor={dobMonthErrorDay}>Day</StyledLabel>
            <StyledInput
              id={dobMonthErrorDay}
              name={name}
              pattern="[0-9]*"
        ...
        <StyledDiv5>
          <StyledDiv6>
            <StyledLabel2 htmlFor={dobMonthErrorMonth}>Month</StyledLabel2>
            <StyledInput2
        ...
        <StyledDiv7>
          <StyledDiv8>
            <StyledLabel3 htmlFor={dobMonthErrorYear}>Year</StyledLabel3>
            <StyledInput3
