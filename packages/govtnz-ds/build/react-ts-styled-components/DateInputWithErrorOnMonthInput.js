            ...
            React.createElement(StyledDiv2, { id: dobMonthError },
                React.createElement(StyledDiv3, null,
                    React.createElement(StyledDiv4, null,
                        ...
                        React.createElement(StyledInput, { id: dobMonthErrorDay, name: name, pattern: "[0-9]*", type: constants.type[type], disabled: disabled, readOnly: readOnly, autoFocus: autoFocus, value: value, spellCheck: spellCheck, maxLength: maxLength, autoComplete: constants.autoComplete[autoComplete], onChange: onChange }))),
                React.createElement(StyledDiv5, null,
                    React.createElement(StyledDiv6, null,
                        ...
                        React.createElement(StyledInput2, { id: dobMonthErrorMonth, name: name2, pattern: "[0-9]*", type: constants.type2[type2], disabled: disabled2, readOnly: readOnly2, autoFocus: autoFocus2, value: value2, spellCheck: spellCheck2, maxLength: maxLength2, autoComplete: constants.autoComplete2[autoComplete2], onChange: onChange2 }))),
                React.createElement(StyledDiv7, null,
                    React.createElement(StyledDiv8, null,
                        ...
                        React.createElement(StyledInput3, { id: dobMonthErrorYear, name: name3, pattern: "[0-9]*", type: constants.type3[type3], disabled: disabled3, readOnly: readOnly3, autoFocus: autoFocus3, value: value3, spellCheck: spellCheck3, maxLength: maxLength3, autoComplete: constants.autoComplete3[autoComplete3], onChange: onChange3 })))))));
};
