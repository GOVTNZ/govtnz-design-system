...
var FlexRow = function (_a) {
    ...
    return (react_1.default.createElement(StyledDiv, { xsVerticalAlign: xsVerticalAlign, smVerticalAlign: smVerticalAlign, mdVerticalAlign: mdVerticalAlign, lgVerticalAlign: lgVerticalAlign, xsReversed: xsReversed, smReversed: smReversed, mdReversed: mdReversed, lgReversed: lgReversed, isReversed: isReversed, className: className }, children !== undefined ? (children) : (react_1.default.createElement(react_1.default.Fragment, null, "Columns..."))));
};
