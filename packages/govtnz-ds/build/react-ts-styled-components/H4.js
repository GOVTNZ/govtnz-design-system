...
const StyledH4 = styled.h4 `
  ...
  ${props => props.marginBottom8 &&
    ...
    `}
`;
const H4 = ({ styleSize, marginBottom8, id, children }) => (React.createElement(StyledH4, { styleSize: styleSize, marginBottom8: marginBottom8, id: id }, children !== undefined ? (children) : (React.createElement(React.Fragment, null, "Example text"))));
