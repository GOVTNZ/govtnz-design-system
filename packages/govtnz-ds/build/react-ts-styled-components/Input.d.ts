...
declare const Input: ({ width, hasError, fakeFocus, inputId, describedBy, name, disabled, readOnly, autoFocus, value, type, spellCheck, autoComplete, onChange }: Props) => JSX.Element;
