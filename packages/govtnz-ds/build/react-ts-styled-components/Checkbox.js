...
var Checkbox = function (_a) {
    ...
    return (react_1.default.createElement(StyledInput, { "aria-describedby": hintId, id: id, type: "checkbox", disabled: disabled !== undefined ? disabled.toString() === "true" : undefined, readOnly: readOnly, autoFocus: autoFocus, name: name, value: value, checked: checked, onChange: onChange, ref: ref }));
};
