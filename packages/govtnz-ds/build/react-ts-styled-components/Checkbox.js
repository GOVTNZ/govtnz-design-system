...
var Checkbox = function (_a) {
    ...
    return (React.createElement(StyledInput, { "aria-describedby": hintId, id: id, type: "checkbox", disabled: disabled, readOnly: readOnly, autoFocus: autoFocus, name: name, value: value, checked: checked, onChange: onChange }));
};
