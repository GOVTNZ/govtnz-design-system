...
declare const TextareaWithErrorMessage: ({ noNiReason, noNiReasonError, name, disabled, readOnly, rows, cols, autoFocus, spellCheck, autoComplete, value, onChange }: Props) => JSX.Element;
