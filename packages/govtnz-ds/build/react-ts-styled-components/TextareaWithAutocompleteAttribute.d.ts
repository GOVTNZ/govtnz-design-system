...
declare const TextareaWithAutocompleteAttribute: ({ textareaWithAutocompleteAttribute, name, disabled, readOnly, rows, cols, autoFocus, spellCheck, autoComplete, value, onChange }: Props) => JSX.Element;
