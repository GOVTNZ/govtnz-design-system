...
declare const TextareaWithAutocompleteAttribute: ({ textareaWithAutocompleteAttribute, name, disabled, readOnly, rows, cols, autoFocus, spellCheck, autoComplete, maxLength, value, onChange }: Props) => JSX.Element;
