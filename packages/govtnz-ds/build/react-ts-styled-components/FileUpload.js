...
var FileUpload = function (_a) {
    ...
    return (React.createElement(StyledDiv, null,
        React.createElement(StyledLabel, { htmlFor: id }, "Upload a file"),
        React.createElement(StyledInput, { id: id, name: name, type: "file", disabled: disabled, readOnly: readOnly, autoFocus: autoFocus })));
};
