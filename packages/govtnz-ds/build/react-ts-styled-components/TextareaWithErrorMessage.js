...
var TextareaWithErrorMessage = function (_a) {
    var noNiReason = _a.noNiReason, noNiReasonError = _a.noNiReasonError, name = _a.name, disabled = _a.disabled, readOnly = _a.readOnly, rows = _a.rows, cols = _a.cols, autoFocus = _a.autoFocus, spellCheck = _a.spellCheck, autoComplete = _a.autoComplete, maxLength = _a.maxLength, value = _a.value, onChange = _a.onChange;
    return (React.createElement(StyledDiv, null,
        ...
        React.createElement(StyledTextarea, { "aria-describedby": noNiReasonError, id: noNiReason, name: name, rows: rows, disabled: disabled, readOnly: readOnly, cols: cols, autoFocus: autoFocus, spellCheck: spellCheck, autoComplete: constants.autoComplete[autoComplete], maxLength: maxLength, value: value, onChange: onChange })));
};
