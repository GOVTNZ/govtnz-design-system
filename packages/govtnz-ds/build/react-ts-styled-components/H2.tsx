...
const StyledH2 = styled.h2<Pick<Props, "styleSize" | "marginBottom8">>`
  ${props =>
...
const H2 = ({ styleSize, marginBottom8, id, children }: Props) => (
  <StyledH2 styleSize={styleSize} marginBottom8={marginBottom8} id={id}>
    {children !== undefined ? (
      children
    ) : (
