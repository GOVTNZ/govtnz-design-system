...
var TextareaWithCustomRows = function (_a) {
    ...
    return (React.createElement(StyledDiv, null,
        ...
        React.createElement(StyledTextarea, { id: fullAddress, name: name, rows: rows, disabled: disabled, readOnly: readOnly, cols: cols, autoFocus: autoFocus, spellCheck: spellCheck, autoComplete: constants.autoComplete[autoComplete], maxLength: maxLength, value: value, onChange: onChange })));
};
