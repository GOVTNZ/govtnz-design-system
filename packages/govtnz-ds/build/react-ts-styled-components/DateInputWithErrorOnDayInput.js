...
var DateInputWithErrorOnDayInput = function (_a) {
    var dobDayErrorHint = _a.dobDayErrorHint, dobDayErrorError = _a.dobDayErrorError, dobDayError = _a.dobDayError, dobDayErrorDay = _a.dobDayErrorDay, name = _a.name, disabled = _a.disabled, readOnly = _a.readOnly, autoFocus = _a.autoFocus, value = _a.value, type = _a.type, spellCheck = _a.spellCheck, maxLength = _a.maxLength, autoComplete = _a.autoComplete, onChange = _a.onChange, dobDayErrorMonth = _a.dobDayErrorMonth, name2 = _a.name2, disabled2 = _a.disabled2, readOnly2 = _a.readOnly2, autoFocus2 = _a.autoFocus2, value2 = _a.value2, type2 = _a.type2, spellCheck2 = _a.spellCheck2, maxLength2 = _a.maxLength2, autoComplete2 = _a.autoComplete2, onChange2 = _a.onChange2, dobDayErrorYear = _a.dobDayErrorYear, name3 = _a.name3, disabled3 = _a.disabled3, readOnly3 = _a.readOnly3, autoFocus3 = _a.autoFocus3, value3 = _a.value3, type3 = _a.type3, spellCheck3 = _a.spellCheck3, maxLength3 = _a.maxLength3, autoComplete3 = _a.autoComplete3, onChange3 = _a.onChange3;
            ...
            React.createElement(StyledDiv2, { id: dobDayError },
                React.createElement(StyledDiv3, null,
                    React.createElement(StyledDiv4, null,
                        ...
                        React.createElement(StyledInput, { id: dobDayErrorDay, name: name, pattern: "[0-9]*", type: constants.type[type], disabled: disabled, readOnly: readOnly, autoFocus: autoFocus, value: value, spellCheck: spellCheck, maxLength: maxLength, autoComplete: constants.autoComplete[autoComplete], onChange: onChange }))),
                React.createElement(StyledDiv5, null,
                    React.createElement(StyledDiv6, null,
                        ...
                        React.createElement(StyledInput2, { id: dobDayErrorMonth, name: name2, pattern: "[0-9]*", type: constants.type2[type2], disabled: disabled2, readOnly: readOnly2, autoFocus: autoFocus2, value: value2, spellCheck: spellCheck2, maxLength: maxLength2, autoComplete: constants.autoComplete2[autoComplete2], onChange: onChange2 }))),
                React.createElement(StyledDiv7, null,
                    React.createElement(StyledDiv8, null,
                        ...
                        React.createElement(StyledInput3, { id: dobDayErrorYear, name: name3, pattern: "[0-9]*", type: constants.type3[type3], disabled: disabled3, readOnly: readOnly3, autoFocus: autoFocus3, value: value3, spellCheck: spellCheck3, maxLength: maxLength3, autoComplete: constants.autoComplete3[autoComplete3], onChange: onChange3 })))))));
};
