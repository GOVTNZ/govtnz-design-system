...
var SelectBlock = function (_a) {
    ...
    return (React.createElement(StyledDiv, { errorId: errorId },
        React.createElement(StyledLabel, { htmlFor: selectId }, label !== undefined ? (label) : (React.createElement(React.Fragment, null, "Example label text"))),
        React.createElement(StyledSelect, { error: error, id: selectId, name: name, multiple: multiple, onChange: onChange }, children !== undefined ? (children) : (React.createElement(React.Fragment, null,
