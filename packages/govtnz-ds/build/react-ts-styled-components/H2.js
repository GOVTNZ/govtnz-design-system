...
const StyledH2 = styled.h2 `
  ...
  ${props => props.marginBottom8 &&
    ...
    `}
`;
const H2 = ({ styleSize, marginBottom8, id, children }) => (React.createElement(StyledH2, { styleSize: styleSize, marginBottom8: marginBottom8, id: id }, children !== undefined ? (children) : (React.createElement(React.Fragment, null, "Example text"))));
