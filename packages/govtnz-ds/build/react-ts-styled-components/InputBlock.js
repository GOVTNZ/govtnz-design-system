...
var InputBlock = function (_a) {
    ...
    return (React.createElement(StyledDiv, { error: error },
        ...
        React.createElement(StyledInput, { width: width, error: error, "aria-describedby": hintId !== undefined || errorId !== undefined
                ...
                : undefined, id: inputId, name: name, type: "text", disabled: disabled, readOnly: readOnly, autoFocus: autoFocus, value: value, spellCheck: spellCheck, maxLength: maxLength, autoComplete: constants.autoComplete[autoComplete], onChange: onChange })));
};
