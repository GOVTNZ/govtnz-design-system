...
var InputBlock = function (_a) {
    ...
    return (React.createElement(StyledDiv, { errorId: errorId },
        React.createElement(StyledLabel, { htmlFor: id }, label !== undefined ? (label) : (React.createElement(React.Fragment, null, "Example text"))),
        ...
        React.createElement(StyledInput, { width: width, error: error, "aria-describedby": hintId !== undefined || errorId !== undefined
                ...
                : undefined, id: id, name: name, disabled: disabled, readOnly: readOnly, autoFocus: autoFocus, value: value, min: min, max: max, type: type, spellCheck: spellCheck, maxLength: maxLength, autoComplete: autoComplete, onChange: onChange })));
};
