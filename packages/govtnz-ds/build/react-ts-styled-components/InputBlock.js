...
const InputBlock = ({ hasError, inputId, label, hintId, hint, errorId, error, width, fakeFocus, name, disabled, readOnly, autoFocus, value, type, spellCheck, autoComplete, onChange }) => (React.createElement(StyledDiv, { hasError: hasError },
