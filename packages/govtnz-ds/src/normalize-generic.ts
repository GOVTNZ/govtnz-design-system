...
export const normalizeGeneric = async (upstreamReleaseVersion: ReleaseVersion) => {
  ...
  const newComponents = upstreamReleaseVersion.components.map((component: Component) => {
    bar.tick();
    return {
      ...component,
