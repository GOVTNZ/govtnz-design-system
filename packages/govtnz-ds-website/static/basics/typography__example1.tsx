...
var PageContent = (props) => (<Example title="Example: Same heading level varying by size only (Typography)" {...onChangeGenerator({})}>
        <ExampleSection {...onChangeGenerator({})}>
            <H3 styleSize="xlarge" {...onChangeGenerator({})}>H3 g-heading-xl</H3>
        </ExampleSection>
        <ExampleSection {...onChangeGenerator({})}>
            <H3 styleSize="large" {...onChangeGenerator({})}>H3 g-heading-l</H3>
        </ExampleSection>
        <ExampleSection {...onChangeGenerator({})}>
            <H3 styleSize="medium" {...onChangeGenerator({})}>H3 g-heading-m</H3>
        </ExampleSection>
        <ExampleSection {...onChangeGenerator({})}>
            <H3 styleSize="small" {...onChangeGenerator({})}>H3 g-heading-s</H3>
        </ExampleSection>
        <ExampleSection {...onChangeGenerator({})}>
            <H3 styleSize="xsmall" {...onChangeGenerator({})}>H3 g-heading-xs</H3>
        </ExampleSection>
        <ExampleSection {...onChangeGenerator({})}>
            <H3 styleSize="xxsmall" {...onChangeGenerator({})}>H3 g-heading-xxs</H3>
        </ExampleSection>
    </Example>);
