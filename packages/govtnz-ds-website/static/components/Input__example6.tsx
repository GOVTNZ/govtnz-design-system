...
var PageContent = (props) => (<Example title="Example: Error state #2 (Text input)" {...onChangeGenerator({})}>
        <InputBlock type="text" label="Event name" hint="The name you'll use on promotional material" name="anyName" id="anyId2f" hintId="anyHintId2" errorId="anyErrorId2Error" error="Enter a known event name" {...onChangeGenerator({})}></InputBlock>
    </Example>);
