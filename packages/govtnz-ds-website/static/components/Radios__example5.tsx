...
var PageContent = (props) => (<Example title="Example: Radio buttons" {...onChangeGenerator({})}>
        <FieldsetBlock legend={<H1 styleSize="small" id="nameChangeId1">Have you changed your name?</H1>} hint={<P>This includes changing your last name or spelling your name differently.</P>} hintId="hintId1" {...onChangeGenerator({})}>
