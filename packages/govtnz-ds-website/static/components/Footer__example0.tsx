...
var PageContent = (props) => (<Example title="Example: Footer" {...onChangeGenerator({})}>
        <Footer {...onChangeGenerator({})}>
            ...
            <Subfooter {...onChangeGenerator({})}>
                <FlexContainer width="fixed" {...onChangeGenerator({})}>
                    <FlexRow {...onChangeGenerator({})}>
                        <FlexColumn xs="5" sm="5" md="5" lg="5" className="example-subfooter-column example-subfooter-copyright" {...onChangeGenerator({})}>
                            &copy; Crown Copyright 2020
                        </FlexColumn>
                        <FlexColumn xs="7" sm="7" md="7" lg="7" className="example-subfooter-column example-align-right" {...onChangeGenerator({})}>
