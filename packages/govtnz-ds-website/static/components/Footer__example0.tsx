...
import Footer from '@govtnz/ds/build/react-ts/Footer';import FlexContainer from '@govtnz/ds/build/react-ts/FlexContainer';import FlexRow from '@govtnz/ds/build/react-ts/FlexRow';import FlexColumn from '@govtnz/ds/build/react-ts/FlexColumn';
        ...
        <Footer {...onChangeGenerator({})}>
            <FlexContainer width="fixed" {...onChangeGenerator({})}>
                <FlexRow {...onChangeGenerator({})}>
                    <FlexColumn xs="6" sm="5" md="4" lg="3" {...onChangeGenerator({})}>
                    ...
                    <FlexColumn xs="6" sm="7" md="8" lg="9" {...onChangeGenerator({})}>
