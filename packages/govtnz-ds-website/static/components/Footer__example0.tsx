...
import Footer from '@govtnz/ds/build/react-ts/Footer';import FlexContainer from '@govtnz/ds/build/react-ts/FlexContainer';import FlexRow from '@govtnz/ds/build/react-ts/FlexRow';import FlexColumn from '@govtnz/ds/build/react-ts/FlexColumn';import A from '@govtnz/ds/build/react-ts/A';import Subfooter from '@govtnz/ds/build/react-ts/Subfooter';
...
var PageContent = (props) => (<Example title="Example: Footer" {...onChangeGenerator({})}>
            ...
            <FlexContainer width="fixed" {...onChangeGenerator({})}>
                <FlexRow {...onChangeGenerator({})}>
                    <FlexColumn xs="12" sm="12" md="12" lg="12" {...onChangeGenerator({})}>
                        <A href="#" {...onChangeGenerator({})}>Contact Us</A>
                        <A href="#" {...onChangeGenerator({})}>Privacy</A>
                        <A href="#" {...onChangeGenerator({})}>Copyright</A>
                    </FlexColumn>
                </FlexRow>
            </FlexContainer>
