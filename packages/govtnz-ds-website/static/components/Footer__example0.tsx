...
import Footer from '@govtnz/ds/build/react-ts/Footer';import FlexContainer from '@govtnz/ds/build/react-ts/FlexContainer';import FlexRow from '@govtnz/ds/build/react-ts/FlexRow';import FlexColumn from '@govtnz/ds/build/react-ts/FlexColumn';import FooterLinks from '@govtnz/ds/build/react-ts/FooterLinks';import FooterLink from '@govtnz/ds/build/react-ts/FooterLink';import Subfooter from '@govtnz/ds/build/react-ts/Subfooter';
                    ...
                    <FlexRow xsReversed="true" smReversed="false" mdReversed="false" lgReversed="false" xsVerticalAlign="middle" smVerticalAlign="middle" mdVerticalAlign="middle" lgVerticalAlign="middle" className="example-subfooter-row" {...onChangeGenerator({})}>
                        ...
                        <FlexColumn xs="12" sm="7" md="7" lg="7" xsHorizontalAlign="start" smHorizontalAlign="end" mdHorizontalAlign="end" lgHorizontalAlign="end" {...onChangeGenerator({})}>
                            <a href="https://www.govt.nz/" target="_blank" rel="noreferrer nofollow">
                                <svg role="img" width="230" height="24" className="example-subfooter-logo" focusable="false" aria-labelledby="govtnz-logo">
