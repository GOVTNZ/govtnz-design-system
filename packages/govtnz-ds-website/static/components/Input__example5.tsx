...
var PageContent = (props) => (<Example codeOnly {...onChangeGenerator({})}>
        <InputBlock type="email" label="Your email address" hint="Please provide your personal email address that we'll contact you on." name="someEmail" id="anyId122" hintId="anyHintId122" spellCheck="false" {...onChangeGenerator({})}></InputBlock>
    </Example>);
