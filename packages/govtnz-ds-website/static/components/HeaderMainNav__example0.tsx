...
import MainNavMobileMenuContext from '../../src/commons/MainNavMobileMenuContext';

import Header from '@govtnz/ds/build/react-ts/Header';
import FlexContainer from '@govtnz/ds/build/react-ts/FlexContainer';
import FlexRow from '@govtnz/ds/build/react-ts/FlexRow';
import FlexColumn from '@govtnz/ds/build/react-ts/FlexColumn';
import MainNavMobileMenu from '@govtnz/ds/build/react-ts/MainNavMobileMenu';
import MainNav from '@govtnz/ds/build/react-ts/MainNav';
import MainNavItem from '@govtnz/ds/build/react-ts/MainNavItem';
        ...
        <FlexContainer width="fixed" {...onChangeGenerator({})}>
          <FlexRow {...onChangeGenerator({})}>
            ...
            <FlexColumn
              ...
              {...onChangeGenerator({})}
            >
              <MainNavMobileMenu {...onChangeGenerator({})}>
                menu
              </MainNavMobileMenu>
            </FlexColumn>
            <FlexColumn
            ...
            >
              <MainNav {...onChangeGenerator({})}>
                <MainNavItem href="/" {...onChangeGenerator({})}>
                  Home
                </MainNavItem>
                <MainNavItem href="/about" {...onChangeGenerator({})}>
                  About
                </MainNavItem>
                <MainNavItem href="/contact" {...onChangeGenerator({})}>
                  Contact
                </MainNavItem>
              </MainNav>
            </FlexColumn>
