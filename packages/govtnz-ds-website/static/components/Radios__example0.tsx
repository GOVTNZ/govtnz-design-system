...
var PageContent = (props) => (<Example {...onChangeGenerator()} title="Radios example">
        <FieldsetBlock {...onChangeGenerator()} legend={<H1 {...onChangeGenerator()} styleSize="large" id="nameChangeId1">Have you changed your name?</H1>} hint={<p>This includes changing your last name or spelling your name differently.</p>} hintId="hintId1">
            <Radios {...onChangeGenerator()} inline>
                <RadioBlock {...onChangeGenerator()} label="Yes" radioId="anyRadioId" 
                value="true" name="nameChange1" labelId="labelId1" hintId="hintId1" />
                <RadioBlock {...onChangeGenerator()} label="No" radioId="anyRadioId255" value="false" name="nameChange1" labelId="labelId255" hintId="hintId1" />
            </Radios>
        </FieldsetBlock>
    </Example>);
