...
var PageContent = (props) => (<Example title="Example: Error state #2 (Radio buttons)" {...onChangeGenerator({})}>
        <FieldsetBlock legend={<H1 styleSize="small" id="nameChangeId8">Have you changed your name?</H1>} hint={<P>This includes changing your last name or spelling your name differently.</P>} hintId="hintId5344" errorId="errorId525" error="Select 'yes' if you have changed your name" {...onChangeGenerator({})}>
