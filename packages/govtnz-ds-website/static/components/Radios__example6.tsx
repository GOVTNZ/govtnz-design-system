...
var PageContent = (props) => (<Example {...onChangeGenerator()}>
        <FieldsetBlockWithError {...onChangeGenerator()} legend={<H1 {...onChangeGenerator()} styleSize="large" id="nameChangeId8">Have you changed your name?</H1>} hint={<p>This includes changing your last name or spelling your name differently.</p>} hintId="hintId5344" errorId="errorId525" error="Select 'yes' if you have changed your name.">
            <Radios {...onChangeGenerator()} inline>
                <RadioBlock {...onChangeGenerator()} label="Yes" radioId="anyRadioId9" 
                value="true" name="nameChange5" labelId="labelId9" />
                <RadioBlock {...onChangeGenerator()} label="No" radioId="anyRadioId10234" value="false" name="nameChange5" labelId="labelId10" />
            </Radios>
