...
var PageContent = (props) => (<Example title="Example: Radio button items with a text divider" {...onChangeGenerator({})}>
            <FieldsetBlock legend={<H1 styleSize="small" id="providerChoiceTitle2">Choose one provider</H1>} hint={<P>Select one provider.</P>} hintId="hintId234" {...onChangeGenerator({})}>
