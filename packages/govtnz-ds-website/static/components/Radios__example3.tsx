...
var PageContent = (props) => (<Example {...onChangeGenerator()}>
        <FieldsetBlock {...onChangeGenerator()} legend={<H1 {...onChangeGenerator()} styleSize="large" id="nameChangeId6">Have you changed your name?</H1>} hint={<p>This includes changing your last name or spelling your name differently.</p>} hintId="hintId2221">
            <Radios {...onChangeGenerator()} inline>
                <RadioBlock {...onChangeGenerator()} label="Yes" radioId="anyRadioId55" 
                value="true" name="nameChange1" labelId="labelId1" hintId="hintId2221" />
                <RadioBlock {...onChangeGenerator()} label="No" radioId="anyRadioId2551" value="false" name="nameChange1" labelId="labelId2" hintId="hintId2221" />
            </Radios>
        </FieldsetBlock>
    </Example>);
