...
export default [
  {
    ...
    "react-ts": "import * as React from \"react\";\nimport * as InsetText from \"@govtnz/ds/build/react-ts/InsetText\";\nimport \"@govtnz/ds/build/css/InsetText.css\"; // or @govtnz/ds/build/scss/InsetText.scss\n\nexport default () => <InsetText />;\n",
    ...
    "react-ts-styled-components": "import * as React from \"react\";\nimport * as InsetText from \"@govtnz/ds/build/react-ts-styled-components/InsetText\";\n\nexport default () => <InsetText />;\n",
    "vue-js": "<template>\n  <inset-text />\n</template>\n<script>\nimport Vue from \"vue\";\nimport InsetText from \"@govtnz/ds/build/vue-js/InsetText\";\n\nexport default { components: { \"inset-text\": InsetText } };\n</script>\n",
    "vue-ts": "<template>\n  <inset-text />\n</template>\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport InsetText from \"@govtnz/ds/build/vue-ts/InsetText\";\n\nexport default { components: { \"inset-text\": InsetText } };\n</script>\n",
    "scss": "",
