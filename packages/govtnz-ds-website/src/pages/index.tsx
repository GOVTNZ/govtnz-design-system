      ...
      <Row>
        <Column xs="12" sm="12" md="9" lg="8" mdOffset="1" lgOffset="1">
          ...
          <P styleSize="medium">
            ...
            functionality across public service websites when the design system
            is implemented. This consistency will breed familiarity, increasing
            user trust and participation in government digital services.
          </P>
          <Row>
            <Column xs="12" sm="6" md="4" lg="4">
              <div className="card">
                ...
                <P styleSize="medium">
                  ...
                  typography. We’re working on layout, iconography, images, and
                  media now.
                </P>
                <P styleSize="medium">
            ...
            <Column xs="12" sm="6" md="4" lg="4">
              <div className="card">
                ...
                <P styleSize="medium">
                  Help users by providing easy flows to complete specific tasks,
                  like setting up accounts, filling in forms, and checking
                  eligibility. We’ll be inviting you to co-design some patterns
                  with us soon.
                </P>
              </div>
            </Column>
          ...
          <P styleSize="medium">
            ...
            strong cross-government community backing it. Our overall aim is to
          ...
          <P styleSize="medium">
            If you have a question, idea, or suggestion about the design system,
