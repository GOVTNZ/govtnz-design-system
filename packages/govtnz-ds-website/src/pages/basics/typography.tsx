...
<H2 {...onChangeGenerator()} styleSize="large" id="font">Font</H2>
...
<ExampleContainer {...onChangeGenerator()}>
    <Example {...onChangeGenerator()}  code={basics__typography[0]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Same heading level varying by size only</ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[1]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Headings with captions</ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[2]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Headings with captions inside the       <code>h1</code></ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[3]} iframeProps={{
...
<Li {...onChangeGenerator()}>a large size for lead paragraphs</Li>
<Li {...onChangeGenerator()}>a medium size for standard body text</Li>
<Li {...onChangeGenerator()}>a smaller size for small body text.</Li>
</Ul>
<p>You can use these text sizes to indicate the relative importance of the content on the page.</p>
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Large size for lead paragraph</ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[4]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Medium size for standard body text</ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[5]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Small size for small body text</ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[6]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Default</ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[7]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
<ExampleHeading {...onChangeGenerator()}>Bulleted lists</ExampleHeading>
<Example {...onChangeGenerator()}  code={basics__typography[8]} iframeProps={{
...
<ExampleContainer {...onChangeGenerator()}>
    <ExampleHeading {...onChangeGenerator()}>Numbered lists</ExampleHeading>
    <Example {...onChangeGenerator()}  code={basics__typography[9]} iframeProps={{
