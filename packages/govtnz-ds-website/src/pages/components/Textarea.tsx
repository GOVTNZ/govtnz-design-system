...
<p>[Insert textarea EXAMPLE 1: DEFAULT]</p>
...
<p>If you need to let users select a single answer from a list of options, use <Link to="./Radios">radio buttons</Link>. For selecting one or more options, or to toggle a single option on or off, use <Link to="./Checkboxes">checkboxes</Link>.</p>
<h3 id="ask-a-simple-open-question">Ask a simple open question</h3>
<p>If you need to let users enter shorter answers no longer than a single line, such as a phone number or name, use the <Link to="./Input">text input</Link> component.</p>
...
<p>If there’s a good reason to limit the number of characters users can enter, you can use the <Link to="./CharacterCount">character count</Link> component.</p>
<h2 id="error-messages">Error messages</h2>
<p>Error messages should be styled like this:</p>
<p>[Insert textarea EXAMPLE 2: ERROR]</p>
