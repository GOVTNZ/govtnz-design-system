...
const PageContent = (props) => <React.Fragment><ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    ...
    <Example {...onChangeGenerator(Example)} code={components__FileUpload[0]} iframeProps={{id:"iframe_componentsFileUpload0", className: "example__iframe", id: "iframe_componentsFileUpload0", src:"../FileUpload__example0/", title:"Example of File Upload", height: 368 }}></Example>
</ExampleContainer>
