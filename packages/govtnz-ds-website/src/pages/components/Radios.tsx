...
<ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    <Example {...onChangeGenerator(Example)} code={components__Radios[0]} iframeProps={{id:"iframe_componentsRadios0", className: "example__iframe", id: "iframe_componentsRadios0", src:"../Radios__example0/", title:"My radios title (Radios example)", height: 284 }}></Example>
</ExampleContainer>
