...
<ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    ...
    <Example {...onChangeGenerator(Example)} code={components__Radios[1]} iframeProps={{id:"iframe_componentsRadios1", className: "example__iframe", id: "iframe_componentsRadios1", src:"../Radios__example1/", title:"Error" }}></Example>
</ExampleContainer>
...
<ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    ...
    <Example {...onChangeGenerator(Example)} code={components__Radios[2]} iframeProps={{id:"iframe_componentsRadios2", className: "example__iframe", id: "iframe_componentsRadios2", src:"../Radios__example2/", title:"Stacked radio buttons" }}></Example>
</ExampleContainer>
...
<ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    ...
    <Example {...onChangeGenerator(Example)} code={components__Radios[3]} iframeProps={{id:"iframe_componentsRadios3", className: "example__iframe", id: "iframe_componentsRadios3", src:"../Radios__example3/", title:"Inline radio buttons" }}></Example>
</ExampleContainer>
...
<ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    ...
    <Example {...onChangeGenerator(Example)} code={components__Radios[4]} iframeProps={{id:"iframe_componentsRadios4", className: "example__iframe", id: "iframe_componentsRadios4", src:"../Radios__example4/", title:"Radio button items with hints" }}></Example>
</ExampleContainer>
...
<ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    ...
    <Example {...onChangeGenerator(Example)} code={components__Radios[5]} iframeProps={{id:"iframe_componentsRadios5", className: "example__iframe", id: "iframe_componentsRadios5", src:"../Radios__example5/", title:"Radio button items with a text divider" }}></Example>
</ExampleContainer>
...
<ExampleContainer {...onChangeGenerator(ExampleContainer)}>
    <ExampleHeading {...onChangeGenerator(ExampleHeading)}>Error</ExampleHeading>
    <Example {...onChangeGenerator(Example)} code={components__Radios[6]} iframeProps={{id:"iframe_componentsRadios6", className: "example__iframe", id: "iframe_componentsRadios6", src:"../Radios__example6/", title:"Error" }}></Example>
</ExampleContainer>
