...
<ExampleContainer>
    ...
    <Example  code={components__Headings[0]} iframeProps={{
...
<ExampleContainer>
    ...
    <Example  code={components__Headings[1]} iframeProps={{
...
<ExampleContainer>
    ...
    <Example  code={components__Headings[2]} iframeProps={{
...
<Example  code={components__Headings[3]} iframeProps={{
