...
const PageContent = props => (
  <React.Fragment>
    <P styleSize="large">
      Use our flexible grid to structure website content. The grid is
      mobile-first, powered by Flexbox, and based on a 12-column system. The
      grid includes gutters, column spanning, 4 breakpoints, and column
      alignment.
    </P>

    <H2 styleSize="large" id="how-it-works">
      How it works
    </H2>
    <p>
      The grid system uses a series of containers, rows, and columns to lay out
      and align content.
    </p>
    <p>
      The following layout (non-responsive) example creates three equal-width
      columns on tablet, desktop, and widescreen devices using our predefined
      grid classes. Those columns are centered in the page with the parent flex
      container.
    </p>
    ...
    <p>
      Flex container width can be fixed or fluid. The fixed container fills the
      available width until it reaches the maximum of 1366 pixels.
    </p>
    <p>
      The fluid container has no constraints and fills all of the available
      space. This is ideal for display uses, such as widescreen HD display.
    </p>
    <h3 id="rows">Rows</h3>
    <p>All columns must have a flex row as a parent.</p>
    <h3 id="columns">Columns</h3>
    <p>
      Our 12-column grid has gutters, column spanning, four breakpoints, and
      column alignment.
    </p>
    <p>
      The &quot;md&quot; in the above example refers to the breakpoint size.
      Here&#39;s the full range of breakpoint options:
    </p>
    <Ul bulleted>
    ...
    <p>
      We also support offsets to allow flexibility of design, essentially
      allowing blank columns to assist aesthetics in layout.
    </p>
    <p>
    ...
    <p>
      We chose Flexbox because it&#39;s implemented by our supported browsers.
      We have labelled this grid type &quot;Flex&quot; so that we can add other
      grid types later. We&#39;re considering adding support for CSS Grid.
    </p>
    <h2 id="credit">Credit</h2>
    <p>
      Original HTML and CSS derived from{' '}
      <a href="http://flexboxgrid.com/">FlexboxGrid</a> version 6.3.2. Licensed
      under{' '}
