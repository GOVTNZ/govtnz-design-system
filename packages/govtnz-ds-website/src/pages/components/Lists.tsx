...
<ExampleContainer>
    ...
    <Example  code={components__Lists[0]} iframeProps={{
...
<ExampleContainer>
    <ExampleHeading>Example of Lists</ExampleHeading>
    <Example  code={components__Lists[1]} iframeProps={{
...
<H2 styleSize="large" id="when-to-use-this-component">When to use this component</H2>
...
<ExampleContainer>
    ...
    <Example  code={components__Lists[2]} iframeProps={{
